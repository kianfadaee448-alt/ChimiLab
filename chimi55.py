...
def configure_opengl_compatibility():
    """فعال‌سازی Compatibility Profile برای glBegin/glEnd و GLU (Qt6 پیش‌فرض Core است)."""
    if not HAS_OPENGL:
        return False
    try:
        fmt = QSurfaceFormat()
        ...
        fmt.setSamples(4)
        # نسخه 2.1 + Compatibility = پشتیبانی fixed-function
        fmt.setVersion(2, 1)
        try:
        ...
        print("[GL] QSurfaceFormat Compatibility 2.1 تنظیم شد", flush=True)
        return True
    except Exception as e:
    ...
    class GLBeakerCanvas(QOpenGLWidget):
        ...
        def __init__(self, engine=None, parent=None):
            ...
            try:
                ...
                print(f"[GL] Beaker setFormat: {e}", flush=True)
            self.engine = engine
        ...
        def paintGL(self):
            try:
                ...
                print(f"[GL] Beaker paintGL error: {e}", flush=True)
    ...
    class GLBohrCanvas(QOpenGLWidget):
        def __init__(self, parent=None):
            ...
            try:
                ...
                print(f"[GL] Bohr setFormat: {e}", flush=True)
            self.setMinimumSize(400, 400)
            self.Z = 0
            self.shells = [0] * 7
            self.angle_x = 20.0
            ...
            self.timer = QTimer(self)
            self.timer.timeout.connect(self.rotate_electrons)
            # timer فقط وقتی visible — در showEvent/hideEvent مدیریت می‌شود
        ...
        def paintGL(self):
            try:
                ...
                print(f"[GL] Bohr paintGL error: {e}", flush=True)
        ...
        def _paintGL_impl(self):
            ...
            if self.quadric is not None:
                ...
                for i in range(17):
                    ...
                    glVertex3f(0.5 * math.cos(a), 0.5 * math.sin(a), 0)
                glEnd()
    ...
    class GLLabWorld(QOpenGLWidget):
        ...
        def __init__(self, engine=None, parent=None):
            ...
            try:
                ...
                print(f"[GL] LabWorld setFormat: {e}", flush=True)
            self.engine = engine
        ...
        def paintGL(self):
            try:
                ...
                print(f"[GL] LabWorld paintGL error: {e}", flush=True)
...
class LoginDialog(QDialog):
    ...
    def _on_name_changed(self, text):
        ...
        if need_set:
            ...
            self.pass_input.setPlaceholderText(f"حداقل {MIN_ADMIN_PASSWORD_LEN} کاراکتر")
        else:
        ...
        if self.lab3d_web is None:
            try:
                ...
                msg = QLabel(
                    ...
                    "① فایل lab3d.html را کنار برنامه قرار دهید\n"
...
if __name__ == '__main__':
    # قبل از ساخت QApplication — ضروری برای Compatibility Profile
    try:
    ...
    print(f"[APP] {APP_NAME} {APP_VERSION} | OpenGL={HAS_OPENGL} | WebEngine={HAS_WEBENGINE} | molmass={HAS_MOLMASS}", flush=True)
