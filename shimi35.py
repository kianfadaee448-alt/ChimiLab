...
import chemparse # اطمینان حاصل کنید که این کتابخانه نصب شده است: pip install chemparse
...
CHEMILAB_DB = {
    ...
    "na": {"name": "سدیم", "formula": "Na", "type": "Metal", "pH": 7.0, "molarity": 1.0, "heat": 0.0,
           "color": "#C0C0C0"},
    "cl": {"name": "کلر", "formula": "Cl2", "type": "Gas", "pH": 3.0, "molarity": 0.1, "heat": -25.0,
            "color": "#ADFF2F"},
...
"alcohol": {
    ...
    "heat": 24.0,
    "color": "#FFFFFF",
    "desc": "الکل طبی برای ضدعفونی و مصرف دارویی"
  },
  "paraffin": {
    "name": "شمع/پارافین",
    "formula": "C25H52",
    ...
    "heat": 50.0,
    "color": "#FFFFE0",
    "desc": "شمع پارافین برای حرارت و روشنایی"
  },
  "starch": {
    "name": "نشاسته",
    "formula": "C6H10O5",
    ...
    "heat": 0.1,
    "color": "#FFE4B5",
    "desc": "کاهش‌دهنده برای آشپزی و صنعت"
  },
  "cuso4": {
    "name": "سولفات مس",
    "formula": "CuSO4",
    ...
    "heat": 0.1,
    "color": "#00BFFF",
    "desc": "نمک مس برای کشاورزی و آزمایشگاه"
  },
  "diamond": {
    "name": "الماس خالص",
    "formula": "C",
...
CUSTOM_REACTIONS = {
    ...
    "خنثی‌سازی اسید و باز": {"reactants": ["HCl", "NaOH"], "products": ["NaCl", "H2O"],
                             "xp": 75},
