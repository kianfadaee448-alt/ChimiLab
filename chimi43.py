...
class ModernLabWindow(QMainWindow):
    ...
    def create_about_tab(self):
        ...
        ۲. راه‌اندازی یک آزمایشگاه واقعی و کامل هزینه‌ای بسیار بالا دارد.
        ۳. دانش‌آموزان مناطق محروم و روستایی تقریباً هرگز یک آزمایش واقعی شیمی را تجربه نکرده‌اند.
        ۴. هر ساله صدها حادثهٔ در آزمایشگاه‌های مدارس رخ می‌دهد.

        هدف پروژه:
        ما می‌خواهیم هر دانش‌آموز، در هر نقطه‌ای از کشور، بدون نیاز به اینترنت، بدون کوچک‌ترین خطر جانی و مالی، بدون هزینه‌های سنگین، آزمایش‌های شیمی را شخصاً تجربه کند.

        با شیمی‌لَب، دیوار بی‌آزمایشگاهی در مدارس کشور فرو می‌ریزد.
        طراح و برنامه‌نویس: کیانوش فدائی"""
