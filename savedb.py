...
"alcohol": {
  ...
  "oil": {
    ...
    "heat": 0,
    "color": "#333333",
    "desc": "ترکیب هیدروکربنی طبیعی مشتق از فسیل‌ها"
  },
  "boron": {
    "name": "بور",
    "formula": "B",
    ...
    "heat": 0,
    "color": "#FFC0CB",
    "desc": "عنصر شیمیایی با کاربردهای صنعتی"
  },
  "silicon": {
    "name": "سیلیسیوم",
    "formula": "Si",
    ...
    "heat": 0,
    "color": "#AAAAAA",
    "desc": "عنصر اصلی سازنده خاک، سنگ و نیمه‌هادی‌ها"
  },
  "mercury": {
    "name": "جیوه",
    "formula": "Hg",
...
"تجزیه پتاسیم بی‌کربنات": {"reactants": ["KHCO3"], "products": ["K2CO3", "CO2", "H2O"], "desc": "تجزیه حرارتی پتاسیم بی‌کربنات.", "xp": 60, "temp_min": 120},
  ...
  "احیای اکسید آهن با کربن": {
    "reactants": ["Fe2O3", "C"],
    "products": ["Fe", "CO2"],
    "desc": "احیای اکسید آهن با کربن و تولید فلز آهن",
    "xp": 80,
    "temp_min": 700
  }
...
for i in CUSTOM_REACTIONS:
    fa_name = i
    reactants = CUSTOM_REACTIONS[i]['reactants']
    products = CUSTOM_REACTIONS[i]['products']
    desc = CUSTOM_REACTIONS[i]['desc']
    xp = CUSTOM_REACTIONS[i]['xp']

    cursor.execute(
        "INSERT INTO custom_reactions (fa_name, reactants, products, desc, xp) VALUES (?, ?, ?, ?, ?)",
        (fa_name, str(reactants), str(products), desc, xp)
    )
