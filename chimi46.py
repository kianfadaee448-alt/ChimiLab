...
QWidget { color: #e0e6f5; font-family: 'Tahoma', sans-serif; font-size: 13px; }
QGroupBox {
    border: 1px solid #3d3d55; border-radius: 14px; margin-top: 18px;
    background-color: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #1a1a28, stop:1 #12121c);
    font-weight: bold;
}
QGroupBox::title {
    subcontrol-origin: margin; subcontrol-position: top center;
    padding: 5px 16px; background-color: #22223a; color: #9db4ff;
    border-radius: 10px; border: 1px solid #4a4a6a;
}
QPushButton {
    background-color: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #32324a, stop:1 #252538);
    border: 1px solid #4a4a65; border-radius: 8px;
    padding: 5px 10px; color: #e8ecf8; font-weight: bold; font-size: 12px;
    min-height: 24px;
}
QPushButton:hover {
    background-color: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #3d3d5c, stop:1 #2e2e48);
    border: 1px solid #8aa4ff;
}
QPushButton:pressed { background-color: #181822; border: 2px solid #ffb86a; }
QPushButton:checked {
    background-color: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #b4f0b0, stop:1 #7dca90);
    color: #0e0e14; border: 2px solid #8eefc0;
}
QLineEdit {
    background-color: #161622; border: 1px solid #3d3d55; border-radius: 10px;
    padding: 8px 12px; color: #9eefb0; font-weight: bold;
}
QLineEdit:focus { border: 1px solid #8aa4ff; background-color: #1a1a2a; }
QComboBox, QDoubleSpinBox, QSpinBox {
    background-color: #161622; border: 1px solid #3d3d55; border-radius: 10px;
    padding: 7px 10px; color: #e0e6f5;
}
QComboBox:hover, QDoubleSpinBox:hover { border: 1px solid #8aa4ff; }
QComboBox QAbstractItemView {
    background-color: #161622; color: #9eefb0;
    selection-background-color: #2a2a42; selection-color: #9eefb0;
    border: 1px solid #3d3d55; outline: 0; padding: 4px;
}
QComboBox QAbstractItemView::item {
    background-color: #161622; color: #9eefb0; padding: 8px 12px; min-height: 30px;
}
QComboBox QAbstractItemView::item:selected { background-color: #2a2a42; color: #b4f0b0; }
QListWidget {
    background-color: #101018; border: 1px solid #2e2e42; border-radius: 12px;
    color: #e0e6f5; font-size: 14px; padding: 4px;
}
QListWidget::item { padding: 8px; border-radius: 8px; }
QListWidget::item:selected { background-color: #2a2a42; color: #9eefb0; }
QListWidget::item:hover { background-color: #1a1a28; }
QTableWidget {
    background-color: #101018; gridline-color: #2e2e42; color: #e0e6f5;
    border: 1px solid #2e2e42; border-radius: 12px;
}
QHeaderView::section {
    background-color: #1a1a28; padding: 9px; border: 1px solid #2e2e42;
    color: #ffd89a; font-weight: bold;
}
QTextEdit {
    background-color: #12121c; border: 1px solid #2e2e42; border-radius: 12px;
    color: #9eefb0; padding: 8px;
}
QTabWidget::pane {
    border: 1px solid #2e2e42; background: #14141e; border-radius: 14px; top: -1px;
}
QTabBar::tab {
    background: #1a1a28; color: #9aa3c0; padding: 6px 10px; margin-right: 2px;
    border-top-left-radius: 8px; border-top-right-radius: 8px;
    border: 1px solid #2e2e42; border-bottom: none;
    font-size: 11px; min-height: 22px; max-height: 28px;
}
QTabBar::tab:selected {
    background: #6b8aef;
    color: #0e0e14; font-weight: bold;
}
QTabBar::tab:hover:!selected { background: #242438; color: #e0e6f5; }
QProgressBar {
    border: 1px solid #3d3d55; border-radius: 9px; text-align: center;
    color: white; background-color: #12121c; height: 18px;
}
QProgressBar::chunk {
    background-color: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #ffb86a, stop:1 #ffd89a);
    border-radius: 8px;
}
QScrollArea { border: none; background-color: transparent; }
QScrollBar:vertical {
    background: #101018; width: 11px; border-radius: 5px; margin: 2px;
}
QScrollBar::handle:vertical {
    background: #3d3d55; border-radius: 5px; min-height: 30px;
}
QScrollBar::handle:vertical:hover { background: #8aa4ff; }
QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { height: 0; }
QDialog { background-color: #161622; border-radius: 14px; }
QToolTip {
    background-color: #1a1a28; color: #9eefb0; border: 1px solid #8aa4ff;
    border-radius: 8px; padding: 8px; font-size: 12px;
}
QToolBar { background-color: #14141e; border: none; spacing: 10px; }
QToolBar QPushButton {
    background-color: #2a2a3e; border: 1px solid #3d3d55; border-radius: 10px;
    padding: 7px 12px; color: #e0e6f5; font-weight: bold; font-size: 13px;
}
QToolBar QPushButton:hover { background-color: #343450; border: 1px solid #8aa4ff; }
QSlider::groove:horizontal { height: 8px; background: #2a2a3e; border-radius: 4px; }
QSlider::handle:horizontal {
    width: 18px; margin: -6px 0; background: #8aa4ff; border-radius: 9px;
}
QSlider::sub-page:horizontal { background: #6b8aef; border-radius: 4px; }
"""
...
class ChemicalCalculator:
    ...
    @staticmethod
    def find_limiting_reagent(reactants_needed, contents_moles, db):
        """
        reactants_needed: list کلید مواد واکنش‌دهنده (فرض ضریب ۱ برای سادگی آموزشی)
        contents_moles: self.contents
        خروجی: (کلید ماده محدودکننده, مول موجود, درصد تبدیل تقریبی)
        """
        ...
        for r in reactants_needed:
            ...
            ratios.append((r, moles, moles))  # ضریب ۱
        if not ratios:
            return None, 0.0, 0.0
        # کمترین مول = محدودکننده
        lim_key, lim_moles, _ = min(ratios, key=lambda x: x[1] if x[1] > 0 else 1e99)
        if lim_moles <= 0:
            return lim_key, 0.0, 0.0
        # درصد تبدیل تقریبی: فرض می‌کنیم واکنش تا اتمام محدودکننده پیش می‌رود
        return lim_key, lim_moles, 100.0
...
class LabEngine:
    ...
    def add_chemical(self, key, amount, custom_molarity=None):
        ...
        # هشدارهای علمی و ایمنی دقیق‌تر بر اساس type
        ...
        for name, rxn in CUSTOM_REACTIONS.items():
            ...
            if len(needed) > 0 and needed.issubset(present):
                ...
                if self.temp_c >= req_temp:
                    ...
                    # تحلیل ترمودینامیکی و ماده محدودکننده
                    dH = ChemicalCalculator.estimate_reaction_delta_h(
                        rxn.get("reactants", []), rxn.get("products", []), CHEMILAB_DB)
                    lim_key, lim_moles, conv_pct = ChemicalCalculator.find_limiting_reagent(
                        rxn.get("reactants", []), self.contents, CHEMILAB_DB)
                    thermo = {
                        "dH": dH,
                    ...
                    if name not in self.discovered:
                        ...
                        if self.score >= self.level * 100:
                            self.level += 1
                        self.save_data()
                        # گرمازایی واقعی‌تر از فیلد heat
...
if HAS_OPENGL:
    class GLBeakerCanvas(QOpenGLWidget):
        ...
        def __init__(self, engine=None, parent=None):
            ...
            self._stirrer_timer.start(50)  # سبک‌تر برای عملکرد
...
class ModernLabWindow(QMainWindow):
    ...
    def toggle_beaker_view(self):
        ...
        # قفل دوباره اندازه دکمه و اسپلیتر
        DimensionController.lock_btn(self.btn_toggle_beaker_view, w=100, h=34)
        if sizes:
    ...
    def create_calc_tools_tab(self):
        ...
        self.lbl_temp_result.setStyleSheet("color: #a6e3a1; font-weight: bold; font-size: 14px;")
        ...
        self.lbl_e_result.setStyleSheet("color: #a6e3a1; font-weight: bold; font-size: 14px;")
        ...
        self.lbl_gas_result.setStyleSheet("color: #a6e3a1; font-weight: bold; font-size: 14px;")
        ...
        self.lbl_pct_result.setStyleSheet("color: #a6e3a1; font-weight: bold;")
        ...
        self.lbl_emp_result.setStyleSheet("color: #a6e3a1; font-weight: bold; font-size: 16px;")
        ...
        self.lbl_st_result.setStyleSheet("color: #a6e3a1; font-weight: bold;")
        ...
        self.lbl_col_result.setStyleSheet("color: #a6e3a1; font-weight: bold;")
    ...
    def create_contents_tab(self):
        ...
        self.table_cont.setColumnCount(6)
        self.table_cont.setHorizontalHeaderLabels(["ماده", "فرمول", "مقدار", "واحد", "مولاریته (M)", "حذف"])
    ...
    def update_contents_ui(self):
        ...
        for i, layer in enumerate(self.engine.visual_layers):
            ...
            self.table_cont.setCellWidget(i, 5, btn_del)
    ...
    def resizeEvent(self, event):
        ...
        try:
            ...
            tb = getattr(self, '_bottom_toolbar_ref', None)
            tlog("resize", "LAYOUT",
                 win=f"{self.width()}x{self.height()}",
                 bottom_vis=tb.isVisible() if tb else None,
                 bottom_h=tb.height() if tb else None,
                 bottom_y=tb.y() if tb else None,
                 bottom_geo=str(tb.geometry()) if tb else None,
                 splitter=self.main_splitter.sizes() if hasattr(self, 'main_splitter') else None,
                 cw_h=self.centralWidget().height() if self.centralWidget() else None)
        except Exception as e:
            tlog(f"resize log error: {e}", "ERROR")
    ...
    def game_loop(self):
        try:
            ...
            if self.engine.speed_multiplier > 0:
                ...
                # نمایش خط نقطه هم‌ارزی هنگام تیتراسیون
                try:
                    ...
                    pass
                if self.data_time:
                    t0, t1 = min(self.data_time), max(self.data_time)
                    if t1 - t0 < 1:
                        t1 = t0 + 1
