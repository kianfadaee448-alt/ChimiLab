...
QLineEdit { background-color: #0d1b2a; border: 1px solid #45475a; border-radius: 4px; padding: 5px; color: #39ff14; font-weight: bold; }
QLineEdit::placeholder { color: #2d6a4f; }
...
QComboBox QAbstractItemView {
    ...
    color: #39ff14;
    selection-background-color: #1b3a4b;
...
if HAS_OPENGL:
    class GLBeakerCanvas(QOpenGLWidget):
        ...
        def _tick_stirrer(self):
            ...
            self.update()  # همیشه رفرش برای نمایش مایع زنده
        ...
        def resizeGL(self, w, h):
            ...
            glLoadIdentity()
            gluPerspective(36, w / max(h, 1), 0.1, 60.0)
...
class AnimatedContainer(QWidget):
    ...
    def process_animations(self):
        ...
        if dt_mult > 0:
            ...
            if self.engine.temp_c < 5.0 and total_amount > 0 and not self.engine.is_broken:
    ...
    def paintEvent(self, event):
        ...
        if not self.engine.is_broken:
            ...
            if self.engine.temp_c < 5.0:
                try:
                    # شدت سرما: از ۵ درجه شروع و زیر صفر قوی‌تر
                    frost_intensity = min(1.0, max(0.15, (5.0 - float(self.engine.temp_c)) / 25.0))
...
class ModernLabWindow(QMainWindow):
    ...
    def _create_left_panel(self):
        ...
        self.search_box.setStyleSheet(
            "background-color: #0d1b2a; color: #39ff14; border: 1px solid #45475a; "
        ...
        self.combo_chem.setStyleSheet("""
            ...
            QComboBox QAbstractItemView {
                background-color: #0d1b2a; color: #39ff14;
                selection-background-color: #1b3a4b; selection-color: #39ff14;
                border: 1px solid #89b4fa; outline: 0;
            }
            QComboBox QAbstractItemView::item {
                background-color: #0d1b2a; color: #39ff14; padding: 6px 10px; min-height: 28px;
            }
            QComboBox QAbstractItemView::item:selected {
                background-color: #1b3a4b; color: #39ff14;
            }
        """)
    ...
    def create_datasheet_tab(self):
        ...
        self.search_input.setStyleSheet(
            "padding: 8px; border-radius: 6px; border: 2px solid #45475a; "
            "background-color: #0d1b2a; color: #39ff14; font-size: 14px; font-weight: bold;")
